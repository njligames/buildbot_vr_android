...
***/
    ...
    public static native void onHeadView(float m11, float m12, float m13, float m14,
...
class SDLSurface extends SurfaceView implements SurfaceHolder.Callback,
    ...
    public void onDraw(Canvas canvas)
    {
        ...
        this.mHeadTracker.getLastHeadView(mHeadView, 0);

        SDLActivity.onHeadView(
                mHeadView[0], mHeadView[1], mHeadView[2], mHeadView[3],
                mHeadView[4], mHeadView[5], mHeadView[6], mHeadView[7],
                mHeadView[8], mHeadView[9], mHeadView[10], mHeadView[11],
